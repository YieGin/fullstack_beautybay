...
const Cart = () => {
  ...
  return (
    <div className="Cart_main">
      <div class="container">
        <h1 class="animated">YOUR SELECTIONS</h1>
        <p></p>
      </div>
      <div className="Cart2">
        <div>
          {cart.map((item) => (
            <div key={item.id} className="Cart3">
              <div>
                <img className="Img_cart3" src={item.img} alt="" />
              </div>
              <div className="Cart4">
                <hr className="Hrr" />
                ...
                <h5 className="Available">Price: ${item.price}</h5>
                <h5 className="Available">AVAILABLE</h5>
                <li style={{ color: "#999", lineHeight: "25px" }}>
                  {item.description1}
                </li>
                <li style={{ color: "#999", lineHeight: "25px" }}>
                  {item.description2}
              ...
              <div className="Cart4_right">
                ...
                >
                  <a class="btn4">
                    ...
                    <span className="Spann"></span>
                    <span className="Spann"></span>
                    <p className="Test">Add to cart</p>
                  </a>
                </div>
                ...
                >
                  <a class="btn4">
                    ...
                    <span className="Spann"></span>
                    <span className="Spann"></span>
                    <p className="Test">Remove from cart</p>
                  </a>
                </div>
		...
		C301.653,311.854,292.998,303.196,282.311,303.196z"
            ...
            <p style={{ color: "#999" }}>ORDER SUMMARY</p>
            <p style={{ color: "#999" }}>USCART378308501</p>
            <hr className="Hr" />
            <div className="Cart5_text">
              <p>Subtotal</p>
            ...
            <hr />
            <p style={{ color: "#999" }}>VIEW DETAILS</p>
            <p className="VIEW">
            ...
            <div className="Flex_Button_center">
              <a className="Shoping-a-Bigger">
                <span className="Shoping-span">PAY WITH </span>
            ...
            <div className="Flex_Button_center">
              <a className="Shoping-a-Bigger2">
                <span className="Shoping-span2">PAY WITH </span>
                <div className="Svg_div">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="60"
                    height="64"
                    viewBox="1.578 2.062 116.844 43.875"
                  >
                    <path
                      fill="#201c1d"
